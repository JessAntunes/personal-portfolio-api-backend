...
class ArtworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create artwork" do
    assert_difference('Artwork.count') do
      post artworks_url, params: { artwork: { animal: @artwork.animal, custom: @artwork.custom, photo: @artwork.photo } }, as: :json
    end
  ...
  test "should update artwork" do
    patch artwork_url(@artwork), params: { artwork: { animal: @artwork.animal, custom: @artwork.custom, photo: @artwork.photo } }, as: :json
    assert_response 200
  end
